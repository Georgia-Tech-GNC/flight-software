/**
  ...
  *          lsm9dstr.c driver.
  *          This is modified from the main register driver.
  ******************************************************************************
  * @attention This is mounted lower on the actual rocket
  *
  ******************************************************************************
  */
...
Little Endian: LSSB at smallest location and MSB at largest location
Big Endian: MSB has mallest while LSB has biggest
*/
...
/** @addtogroup  Interfaces_Functions
  * @brief       This section provide a set of instructions used to read and
...
typedef struct {
  ...
  /** Optional, but here due to standard **/
  void *handle;
} stmdev_ctx_t;
...
/** Device Identification for IMU **/
#define LSM9DS1_IMU_ID             0x68U

/** Device Identification for magnetometer **/
...
/**
  ...
  *           description.
  *           This union is useful, but not necessarily mandatory. 
  *
