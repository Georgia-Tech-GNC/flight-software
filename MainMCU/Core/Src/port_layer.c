...
#else
TaskHandle_t g_static_fire_task_handle;
StackType_t static_fire_task_stack[4096];
StaticTask_t static_fire_task_buff;
#endif
...
#else
    g_static_fire_task_handle = xTaskCreateStatic(static_fire_task, "static_fire_task", 4096, NULL, tskIDLE_PRIORITY, static_fire_task_stack, &static_fire_task_buff);
    if (g_static_fire_task_handle == NULL) return 0;
#endif
