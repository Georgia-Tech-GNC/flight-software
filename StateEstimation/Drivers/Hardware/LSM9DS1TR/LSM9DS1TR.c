...
/**
  ...
  *
  */
int32_t __weak lsm9ds1_read_reg(const stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data, uint16_t len) {
  int32_t ret;
...
/**
  ...
  *
  */
int32_t __weak lsm9ds1_write_reg(const stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data, uint16_t len) {
  int32_t ret;
  if (ctx == NULL) return -1;
...
int32_t lsm9ds1_gy_full_scale_set(const stmdev_ctx_t *ctx, lsm9ds1_gy_fs_t val) {
  ...
  if (ret == 0) {
    ...
    ret = lsm9ds1_write_reg(ctx, LSM9DS1_CTRL_REG1_G, (uint8_t *)&ctrl_reg1_g, 1);
  } 
  return ret;
}
...
int32_t lsm9ds1_imu_data_rate_set(const stmdev_ctx_t *ctx,
  ...
  if (ret == 0) {
    ...
    ret = lsm9ds1_write_reg(ctx, LSM9DS1_CTRL_REG3_G, (uint8_t *)&ctrl_reg3_g, 1);
  }
...
int32_t lsm9ds1_gy_orient_set(const stmdev_ctx_t *ctx, lsm9ds1_gy_orient_t val) {
  ...
  int32_t ret;
  ret = lsm9ds1_read_reg(ctx, LSM9DS1_ORIENT_CFG_G, (uint8_t *)&orient_cfg_g, 1);
  if (ret == 0) {
...
int32_t lsm9ds1_xl_axis_set(const stmdev_ctx_t *ctx, lsm9ds1_xl_axis_t val) {
  ...
  int32_t ret;
  ret = lsm9ds1_read_reg(ctx, LSM9DS1_CTRL_REG5_XL, (uint8_t *)&ctrl_reg5_xl, 1);
  if (ret == 0) {
...
int32_t lsm9ds1_block_data_update_set(const stmdev_ctx_t *ctx_mag, stmdev_ctx_t *ctx_imu, uint8_t val) {
  ...
  if (ret == 0) {
    ...
    ret = lsm9ds1_write_reg(ctx_mag, LSM9DS1_CTRL_REG5_M, (uint8_t *)&ctrl_reg5_m, 1);
  }
  return ret;
}
...
int32_t lsm9ds1_mag_full_scale_set(const stmdev_ctx_t *ctx, lsm9ds1_mag_fs_t val) {
  ...
  if (ret == 0) {
    ...
    ret = lsm9ds1_write_reg(ctx, LSM9DS1_CTRL_REG2_M, (uint8_t *)&ctrl_reg2_m, 1);
  }
  return ret;
}
...
int32_t lsm9ds1_mag_flag_data_ready_get(const stmdev_ctx_t *ctx, uint8_t *val) {
  ...
  int32_t ret;
  ret = lsm9ds1_read_reg(ctx, LSM9DS1_STATUS_REG_M, (uint8_t *)&status_reg_m, 1);
...
int32_t lsm9ds1_dev_id_get(const stmdev_ctx_t *ctx_mag, stmdev_ctx_t *ctx_imu, lsm9ds1_id_t *buff) {
  ...
  if (ret == 0) {
    ret = lsm9ds1_read_reg(ctx_mag, LSM9DS1_WHO_AM_I_M, (uint8_t *) & (buff->mag), 1);
  }
  return ret;
}
...
int32_t lsm9ds1_dev_status_get(const stmdev_ctx_t *ctx_mag, stmdev_ctx_t *ctx_imu, lsm9ds1_status_t *val) {
  int32_t ret;
  ret = lsm9ds1_read_reg(ctx_imu, LSM9DS1_STATUS_REG, (uint8_t *) & (val->status_imu), 1);
  if (ret == 0) {
    ret = lsm9ds1_read_reg(ctx_mag, LSM9DS1_STATUS_REG_M, (uint8_t *) & (val->status_mag), 1);
  }
  return ret;
}
...
int32_t lsm9ds1_dev_reset_set(const stmdev_ctx_t *ctx_mag, stmdev_ctx_t *ctx_imu, uint8_t val) {
  ...
  if (ret == 0) {
    ret = lsm9ds1_read_reg(ctx_mag, LSM9DS1_CTRL_REG2_M, (uint8_t *)&ctrl_reg2_m, 1);
  }

  if (ret == 0) {
    ctrl_reg2_m.soft_rst = (uint8_t)val;
    ret = lsm9ds1_write_reg(ctx_mag, LSM9DS1_CTRL_REG2_M, (uint8_t *)&ctrl_reg2_m, 1);
  }
  return ret;
}
